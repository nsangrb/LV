...
{
    public class Node2Controller : Controller
    {
        ...
        public ActionResult Temp()
        {
            try
            {
                ViewBag.DataNode2 = JsonConvert.SerializeObject(_Db.DbTableNode2.ToList(), _jsonSetting);
                return View();
            }
        ...
        public ActionResult CreateData(string msg="")
        {
            try
            {
                ...
                SqlCommand cmd = new SqlCommand("AddDTNode2", con);
